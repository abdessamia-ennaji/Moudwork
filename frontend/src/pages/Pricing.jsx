    ...
    <div className="container">
      <div className="row text-center">
        <div className="col-12">
          ...
          <h3 className="section-sub-title">Pricing Plans</h3>
        </div>
      </div>
      {/*/ Title row end */}
      <div className="row">
          ...
          <div className="ts-pricing-box">
            ...
            <div className="ts-pricing-features">
              <ul className="list-unstyled">
                ...
                <li>Schedule Management and Claims</li>
                <li>Phased Project Development</li>
              </ul>
            </div>
            {/* Features end */}
        ...
        <div className="col-lg-4 col-md-6">
          <div className="ts-pricing-box ts-pricing-featured">
            <div className="ts-pricing-header">
              <h2 className="ts-pricing-name">Renovation Projects</h2>
              <h2 className="ts-pricing-price">
                <span className="currency">$</span>
                <strong>179.9</strong>
                <small>/Month</small>
            ...
            <div className="ts-pricing-features">
              <ul className="list-unstyled">
                ...
                <li>Detailed Feasibility Studies</li>
                <li>Expert On-site Representation</li>
                <li>Thorough Quality Inspections</li>
                <li>Comprehensive Schedule Management</li>
                <li>Strategic Project Phasing</li>
              </ul>
            </div>
            {/* Features end */}
            <div className="plan-action">
          ...
          <div className="ts-pricing-box">
            ...
            <div className="ts-pricing-features">
              <ul className="list-unstyled">
                ...
                <li>In-depth Feasibility Analysis</li>
                <li>Full On-site Supervision</li>
                <li>Stringent Quality Control</li>
                <li>Effective Schedule and Claims Management</li>
                <li>Complete Project Phasing</li>
              </ul>
            </div>
            {/* Features end */}
            <div className="plan-action">
