                ...
                <div id="top-bar" className="top-bar">
                        ...
                        <div className="row">
                            ...
                            <ul className="list-unstyled">
                                <li>
                                <a title="Facebook" href="https://facebbok.com/themefisher.com" target="_blank" >
                                ...
                                <a title="Linkdin" href="https://github.com/themefisher.com" target="_blank">
                                    <span className="social-icon">
                                ...
                                {/* <a title="Linkdin" href="https://github.com/themefisher.com" target="_blank">
                                    <span className="social-icon">
                                        <img src="https://www.flaticon.com/media/dist/min/img/flags/fr.svg" width="16" height="11" loading="lazy"></img>
                                    </span>
                                </a>

                                <a title="Linkdin" href="https://github.com/themefisher.com" target="_blank">
                                    <span className="social-icon">
                                        <img src="https://www.flaticon.com/media/dist/min/img/flags/en.svg" width="16" height="11" loading="lazy"></img>
                                    </span>
                                </a> */}
